    ...
    if first:
        ...
        if buttons[previousX, previousY]['text'] != buttons[x, y]['text']:
            ...
            if pairs == len(buttons)/2:
                # messagebox.showinfo('Количество ходов','Сделано ходов:' + str(moves), command=close_window)
                info_message = messagebox.showinfo('Количество ходов', 'Сделано ходов:' + str(moves))
                if info_message:
                    close_window()
        first = True
