...
class Button: #22 создаем класс для кнопок
    def __init__(self, x, y,): # конструктор класса в котором мы просим указать координаты будущей кнопки
...
eat_button = Button(button_x, PADDING )  #22  3 создание кнопки еды
