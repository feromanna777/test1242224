...
class Wolf(pg.sprite.Sprite):
    def __init__(self):
        ...
        self.image = pg.image.load("волк1.png")
        size = random.randint(70, 150)
...
class Hero(pg.sprite.Sprite):
    def __init__(self):
        ...
        self.image = pg.image.load("игроксверхувправо.png")
    ...
    def switch_mode(self):
        self.image = pg.image.load("игроксверхувверх.png")
        self.image = pg.transform.scale(self.image, (100, 100))
...
class Girl1(pg.sprite.Sprite):
    def __init__(self):
        pg.sprite.Sprite.__init__(self)

        self.image = pg.image.load("girl1.png")
...
class Girl2(pg.sprite.Sprite):
    def __init__(self):
        pg.sprite.Sprite.__init__(self)

        self.image = pg.image.load("girl2.png")
