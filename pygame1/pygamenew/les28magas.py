...
background=pygame.transform.scale(background, (WIDTH, HEIGHT)) #не обязательно но можно
...
while True:
    ...
    if mode == "Shop menu":  #magaz 23.2 добавляем отрисовку меню магазина
