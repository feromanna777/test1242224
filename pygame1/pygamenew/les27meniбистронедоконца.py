...
class Menu:
    def __init__(self,mode):
        ...
        background_image = pygame_menu.BaseImage(
            image_path="img/замок.jpg"
        )
        mytheme = pygame_menu.Theme(background_color=background_image,  # transparent background
                        title_background_color=(4, 47, 126),
                        title_font_shadow=True,
                        widget_padding=25,
                        widget_font_color=(255, 255, 255),  # Red font color for widgets
                        title_font_color=(0, 0, 0),  # Green font color for the title
                        selection_color=(255, 0,0) #цвет при наведении мыши
                        )
