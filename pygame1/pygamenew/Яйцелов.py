...
catcher_start_x2 , catcher_start_y2 , start=180, extent=180, \
...
text= 'счет: ' + str(score ))
lives_remaining = 3
lives_text = c.create_text(canvas_width - 10, 10, anchor='ne', font=game_font, fill= 'dark blue', \
text='Жизней: ' + str(lives_remaining))

# lives_text2 = c.create_text(canvas_width - 300, 300, anchor='ne', font=game_font, fill= 'red', \
# text='Это моя игра')
...
def move_eggs():  #er
    for egg in eggs:
        try:
            ...
            # Объект egg уже удален, просто продолжаем цикл
            pass
    root.after(egg_speed, move_eggs)
