...
import random
import time #mv
pygame.mixer.init()#misic

firstsound=pygame.mixer.Sound("музыкалеса2.mp3")#misic
lose_sound=pygame.mixer.Sound("музыкалесэльфов.mp3")#misic
...
firstsound.set_volume(0.1)#misic
firstsound.play()#misic
...
while True:
    ...
    if time.time() - start_time > 5.0:#misic #22смотрим время дя выигрыша
        firstsound.fadeout(3)#затухание музыка 3 секунды
        lose_sound.play()#misic
